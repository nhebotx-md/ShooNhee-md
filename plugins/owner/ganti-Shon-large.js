...
const pluginConfig = {
    name: 'Shon-large',
    alias: ['setShooNheelarge', 'gantiShooNheelarge'],
    category: 'owner',
    description: 'Preset: Ganti gambar ShooNhee.jpg, serta Shon-v7 hingga ShoNhe-v11.jpg sekaligus',
    usage: '.Shon-large (reply/kirim gambar)',
    example: '.Shon-large',
    isOwner: true,
    isPremium: false,
    isGroup: false,
