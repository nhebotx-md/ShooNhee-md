...
try {
    ...
    if (fs.existsSync(path.join(assetsPath, 'ShoNhe-games.jpg'))) {
        thumbWW = fs.readFileSync(path.join(assetsPath, 'ShoNhe-games.jpg'))
    }
    if (fs.existsSync(path.join(assetsPath, 'ShooNhee.jpg'))) {
        thumbNight = fs.readFileSync(path.join(assetsPath, 'ShooNhee.jpg'))
        thumbDay = fs.readFileSync(path.join(assetsPath, 'ShooNhee.jpg'))
    }
    if (fs.existsSync(path.join(assetsPath, 'ShoNhe-winner.jpg'))) {
        thumbWin = fs.readFileSync(path.join(assetsPath, 'ShoNhe-winner.jpg'))
    }
} catch (e) {
