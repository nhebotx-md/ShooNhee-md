...
const pluginConfig = { name: 'finance-wallet', alias: ['wallet', 'saldo'], category: 'finance', description: 'Lihat saldo NHEfinance', usage: '.wallet', example: '.wallet', isOwner: false, isPremium: false, isGroup: false, isPrivate: true, cooldown: 2, energi: 1, isEnabled: true }
