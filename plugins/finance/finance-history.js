...
const pluginConfig = { name: 'finance-history', alias: ['history', 'riwayat'], category: 'finance', description: 'Riwayat transaksi NHEfinance', usage: '.history', example: '.history', isOwner: false, isPremium: false, isGroup: false, isPrivate: true, cooldown: 2, energi: 1, isEnabled: true }
