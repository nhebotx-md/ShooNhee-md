import { getRandomItem, createSession, getSession, endSession, checkAnswerAdvanced, getHint, hasActiveSession, setSessionTimer, getRemainingTime, formatRemainingTime, isSurrender, isReplyToGame, getRandomReward, getProgressiveHint } from './Shon-game-data.js'
import { getDatabase } from './Shon-database.js'
import { addExpWithLevelCheck } from './Shon-level.js'
import { getGameContextInfo, checkFastAnswer } from './Shon-context.js'
let fetchBuffer
try { fetchBuffer = (await import('./Shon-utils.js')).fetchBuffer } catch {}
...
const games = new ShooNheeGames()

export { ShooNheeGames, games }