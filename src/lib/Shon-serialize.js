...
function createContextInfo(jid, text, title = "", body = "", thumbnail = null) {
  ...
  if (title || body || thumbnail) {
    contextInfo.externalAdReply = {
      ...
      title: title || config.bot?.name || "ShooNhee-AI",
      body: body || "",
      mediaType: 1,
...
async function serialize(sock, msg, store = {}) {
  ...
  if (!senderJid || isLid(senderJid) || isLidConverted(senderJid)) {
    ...
    if (altJid && !isLid(altJid) && !isLidConverted(altJid)) {
      ...
      senderJid = resolveAnyLidToJid(senderJid || m.chat, []);
    }
  }
  m.sender = senderJid;
    ...
    try {
      ...
      m.isAdmin = m.groupMembers.some((p) => {
        ...
        return (
          pNum === senderNum ||
          pLidNum === senderNum ||
          pNum.includes(senderNum) ||
          senderNum.includes(pNum)
        );
      });
      ...
      m.isBotAdmin = m.groupMembers.some((p) => {
        ...
        const pNum = pJid.replace(/[^0-9]/g, "");
        return (
          pNum === botNum || pNum.includes(botNum) || botNum.includes(pNum)
        );
      });
  ...
  m.botName = sock.user?.name || config.bot?.name || "ShooNhee-AI";
  m.messageId = m.id;
  m.chatId = m.chat;
  m.senderId = m.sender;
  ...
  m.reply = async (text, options = {}) => {
      ...
      try {
        ...
        if (replyVariant === 2) {
          contextInfo = {
            ...contextInfo,
            externalAdReply: {
              title: config.bot?.name || "ShooNhee-AI",
          ...
          contextInfo = {
            ...
            forwardedNewsletterMessageInfo: {
              newsletterName: config.saluran?.name || "ShooNhee-AI",
    ...
    if (replyVariant === 4) {
      ...
      let troliThumbnail = getCachedThumb("./assets/images/ShooNhee.jpg");
      ...
      quotedMsg = {
        ...
        message: {
          orderMessage: {
            ...
            status: "INQUIRY",
            surface: "CATALOG",
            message: `${config.bot?.name || "ShooNhee-AI"}`,
      ...
      return sock.sendMessage(
        m.chat,
        {
          ...
          jpegThumbnail: await getCachedSharpThumb(
            join(process.cwd(), "assets/images/ShooNhee2.jpg"),
            300,
            300,
          ),
          caption: text,
        ...
        m.chat,
        {
          ...
          contextInfo: {
            ...
            externalAdReply: {
              ...
              thumbnail: getCachedThumb("./assets/images/ShooNhee2.jpg"),
              mediaType: 1,
              sourceUrl: null,
              renderLargerThumbnail: false,
            },
        ...
        m.chat,
        {
          ...
          contextInfo: {
            ...
            externalAdReply: {
              ...
              thumbnail: getCachedThumb("./assets/images/ShooNhee.jpg"),
              mediaType: 1,
              sourceUrl: null,
              renderLargerThumbnail: true,
            },
      ...
      return sock.sendMessage(
        m.chat,
        {
          video: await getCachedThumb("./assets/video/ShooNhee.mp4"),
          caption: text,
          gifPlayback: true,
          contextInfo: {
            ...contextInfo,
    ...
    return sock.sendMessage(
      m.chat,
      {
        ...
        contextInfo: {
          externalAdReply: {
            showAdAttribution: true,
            title: preview.title || config.bot?.name || "ShooNhee-AI",
            body: preview.body || "",
            mediaType: 1,
            renderLargerThumbnail: true,
