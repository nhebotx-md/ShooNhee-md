...
const gameThumbPath = path.join(assetsPath, 'ShoNhe-games.jpg')
const rpgThumbPath = path.join(assetsPath, 'ShoNhe-rpg.jpg')
const winnerThumbPath = path.join(assetsPath, 'ShoNhe-winner.jpg')
...
function createFakeQuoted(botName = 'ShooNhee-AI', verified = true) {
    return {
        key: {
            fromMe: false,
