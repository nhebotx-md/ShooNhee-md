...
import { jidDecode } from 'ShooNhee'
 ...
 * Participant structure dari ShooNhee (groups.js):
...
export { isLid, isLidConverted, lidToJid, extractNumber, resolveLidFromParticipants, resolveAnyLidToJid, convertLidArray, decodeAndNormalize, resolveParticipant, getParticipantJid, getParticipantJids, findParticipantByNumber, cacheParticipantLids, getCachedJid, normalizeToPhoneNumber, cacheLidJid }